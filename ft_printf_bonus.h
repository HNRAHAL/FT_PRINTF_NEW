...
/*   Updated: 2025/10/28 17:26:51 by hrahal           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int 	x_lower_number_case_one(t_format *flg, int p_nbr ,unsigned int num, int w_nbr);
...
int 	x_lower_number_combined_flags(t_format *flg,unsigned int num,int w_nbr,int p_nbr);// changed this
...
int		x_upper_number_else_case2(t_format *flg, char *str, int w_nbr,
			int p_nbr);
int		x_upper_number_combined_flags(t_format *flg, unsigned int num, int w_nbr,
			int p_nbr);
